...
import { logger, GLOBAL_OBJ, parseSemver, forEachEnvelopeItem, createEnvelope, uuid4, dsnToString, LRUMap, timestampInSeconds } from '@sentry/utils';
...
const THREAD_ID_STRING = String(threadId$1);
...
function createProfilingChunkEvent(
  ...
  return createProfileChunkPayload(client, profile, {
    release: _nullishCoalesce(options.release, () => ( '')),
    environment: _nullishCoalesce(options.environment, () => ( '')),
    start_timestamp: start_timestamp,
    trace_id: _nullishCoalesce(identifiers.trace_id, () => ( '')),
